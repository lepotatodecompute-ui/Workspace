...
const vm_metrics_sab = new SharedArrayBuffer(16);

if (typeof self !== "undefined" && self.location) {
  const params = new URLSearchParams(self.location.search);
  Module["arguments"] = [];
  if (params.get("root") === "vdb") Module["arguments"].push("root=vdb");
  if (params.has("fs")) Module["arguments"].push("fs=" + params.get("fs"));
}
...
function findWasmBinary() {
  return locateFile('emulator.wasm');
}
...
/** @type {function(string, boolean=, number=)} */
  ...
  function _lib_console_input(ins, len) {
  ...
  function _lib_console_output(outs, len) {
      /* First lock the buffer */
  ...
  function _lib_ethernet_input(ins, len) {
      /* First lock the buffer */
  ...
  function _lib_ethernet_output(outs, len) {
      /* First lock the buffer */
  ...
  function _lib_harddisk_output(outs, sector, num, readOrWrite) {
      /* First lock the buffer */
  ...
  function _lib_vm_operation() {
      Atomics.add(new Int32Array(vm_metrics_sab), 1, 1);
    }
...
function assignWasmExports(wasmExports) {
  _main_exec_loop = Module['_main_exec_loop'] = wasmExports['main_exec_loop'];
...
var wasmImports = {
  ...
  invoke_viiii,
  /** @export */
  lib_console_input: _lib_console_input,
  /** @export */
  lib_console_output: _lib_console_output,
  /** @export */
  lib_ethernet_input: _lib_ethernet_input,
  /** @export */
  lib_ethernet_output: _lib_ethernet_output,
  /** @export */
  lib_harddisk_input: _lib_harddisk_input,
  /** @export */
  lib_harddisk_output: _lib_harddisk_output,
  /** @export */
  lib_poll_hardware: _lib_poll_hardware,
  /** @export */
  lib_sleep: _lib_sleep,
  /** @export */
  lib_vm_operation: _lib_vm_operation
};
